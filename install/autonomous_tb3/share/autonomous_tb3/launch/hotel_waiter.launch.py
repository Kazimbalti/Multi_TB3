...
def generate_launch_description():
    ...
    output='screen',
    executable='sdf_spawner',
    name='actor_spawner_1',
    arguments=[actor_path, "actor1", "1.0", "1.0"]  # Adjust x, y positions as needed
)
    ...
    actor_spawn_2 = Node(
        ...
        output='screen',
        executable='sdf_spawner',
        name='actor_spawner_2',
        arguments=[actor_path, "actor2", "-1.0", "-1.0"]  # Adjust x, y positions as needed
    )
    ...
    ld.add_action(actor_spawn_1)
    ld.add_action(actor_spawn_2)
